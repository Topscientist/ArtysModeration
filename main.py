...
async def on_message(message):
    ...
    if any(word in msg for word in sad_words):
      ...
      embed = discord.Embed(title="Arty's Moderation Report Help!", colour=discord.Colour(0x11806a))
      ...
      if sudo == "<@786182411465392128>":
        ...
        embed = discord.Embed(
              ...
              description='**The Artys Moderation Bot is being restarted** Please allow up to 3 seconds for the bot to completly shutdown before restarting in order to finish off any sub-processes. A message will be sent in chat when this process is complete. *Please note: The website will remain operational and will not be restarted*',
        ...
        sleep (3)
        print ('')
        print ('Sudo Restart> Artymartin3459 or another sudo user has restarted Artys Moderation')
        emoji = '✅'
        await message.add_reaction(emoji)
        ...
        if sudo == "<@786182411465392128>":
          ...
          embed = discord.Embed(
                ...
                description='**The Artys Moderation Bot is being shut down** Please allow up to 3 seconds for the bot to completly shut down and finish off any sub-processes. A message will be sent in chat when this process is complete. *Please note: The website will remain operational*',
                color=discord.Colour.greyple())
          await message.channel.send(embed=embed)
          print ('')
